(function () {
  const SHEET_URL = "https://script.google.com/macros/s/AKfycbwZ-hs2LDJn4tPd5_XBiRjwFXGaP8lL2Fo9g4vRBzs0Vnoc5QNNojVhKkNuqv73E7JH/exec";
  ...
  const css = `
    ...
    ._cb_header{padding:16px 18px;background:#AA3B4B;display:flex;align-items:center;gap:12px;}
    ...
    ._cb_user{background:#AA3B4B;color:#fff;border-bottom-right-radius:4px;align-self:flex-end;}
    ._cb_qr{display:flex;flex-wrap:wrap;gap:6px;margin-top:4px;animation:_cb_up .25s ease;}
    ._cb_qrbtn{padding:7px 12px;border-radius:20px;border:1.5px solid #AA3B4B;background:#fff;font-size:12px;color:#AA3B4B;cursor:pointer;transition:all .15s;font-family:inherit;white-space:nowrap;font-weight:500;}
    ...
    ._cb_typing span{width:6px;height:6px;border-radius:50%;background:#AA3B4B;animation:_cb_bounce 1.2s infinite;display:inline-block;}
    ...
    ._cb_emailbox{background:#f0f5ff;border:1.5px solid #AA3B4B;border-radius:14px;padding:14px;animation:_cb_up .3s ease;align-self:flex-start;width:90%;}
    ...
    ._cb_esubmit{width:100%;padding:10px;background:#AA3B4B;color:#fff;border:none;border-radius:8px;font-size:13px;cursor:pointer;font-family:inherit;font-weight:600;transition:background .15s;}
    ...
    #_cb_sendbtn{width:36px;height:36px;border-radius:50%;background:#AA3B4B;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0;transition:background .15s;}
  ...
  win.innerHTML = `
    <div class="_cb_header">
      ...
      <div>
        <div class="_cb_hname">UDT Event Assistant</div>
    ...
    <div class="_cb_powered">UDT Event 2026 · Smart Assistant</div>
  `;
  ...
  const MAIN_QRS = ["What is UDT Event?", "Event Date & Location", "How to Register?", "Sponsorship Packages"];
  ...
  function greet() {
    ...
    setTimeout(() => {
      removeTyping();
      addBot("👋 Hello! Welcome to UDT Event 2026!\n\nWe're glad you're here. Please enter your email below to get started and receive updates about our upcoming expo in Abu Dhabi. 📩");
  ...
  function submitEmail() {
    ...
    setTimeout(() => {
      removeTyping();
      addBot("🎉 Thank you! Your email has been saved.\n\nWe'll keep you updated on UDT Event EXPO 2026 in Abu dhabi. Now, how can I help you today?", MAIN_QRS);
    }, 800);
  }
